...
namespace LeapInternal {
  ...
  public class Connection {
    ...
    public void SetPolicy(LeapMotion.PolicyFlag policy) {
    ...
    public void ClearPolicy(LeapMotion.PolicyFlag policy) {
    ...
    private eLeapPolicyFlag flagForPolicy(LeapMotion.PolicyFlag singlePolicy) {
      switch (singlePolicy) {
        case LeapMotion.PolicyFlag.POLICY_BACKGROUND_FRAMES:
          return eLeapPolicyFlag.eLeapPolicyFlag_BackgroundFrames;
        case LeapMotion.PolicyFlag.POLICY_IMAGES:
          return eLeapPolicyFlag.eLeapPolicyFlag_Images;
        case LeapMotion.PolicyFlag.POLICY_OPTIMIZE_HMD:
          return eLeapPolicyFlag.eLeapPolicyFlag_OptimizeHMD;
        case LeapMotion.PolicyFlag.POLICY_ALLOW_PAUSE_RESUME:
          return eLeapPolicyFlag.eLeapPolicyFlag_AllowPauseResume;
        case LeapMotion.PolicyFlag.POLICY_MAP_POINTS:
          return eLeapPolicyFlag.eLeapPolicyFlag_MapPoints;
        case LeapMotion.PolicyFlag.POLICY_DEFAULT:
          return 0;
        default:
          return 0;
      }
    ...
    /// @since 2.1.6
    /// </summary>
    public bool IsPolicySet(LeapMotion.PolicyFlag policy) {
