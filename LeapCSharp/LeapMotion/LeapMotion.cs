...
namespace Leap {
  ...
  /// <summary>
  /// The LeapMotion class is your main interface to the Leap Motion LeapMotion.
  /// 
  ...
  /// using the LeapMotion.Frame() function.Call frame() or frame(0) to get the
  ...
  public class LeapMotion :
    ...
    /// <summary>
    /// Constructs a LeapMotion object.
    /// 
    /// The default constructor uses a connection key of 0.
    /// 
    /// @since 1.0
    /// </summary>
    public LeapMotion() : this(0) { }

    /// <summary>
    /// Constructs a LeapMotion object using the specified connection key.
    /// 
    ...
    /// @since 3.0
    /// </summary>
    public LeapMotion(int connectionKey) {
    ...
    /// LeapMotion.IsPolicySet() after a suitable interval to test whether 
    ...
    /// property. The data in Frame objects taken directly from a Leap.LeapMotion instance
    ...
    /// <summary>
    /// Reports whether this LeapMotion is connected to the Leap Motion service and
    /// the Leap Motion hardware is plugged in.
    /// 
    /// When you first create a LeapMotion object, isConnected() returns false.
    ...
    /// tracking volume.
    /// 
    /// Currently, the Leap Motion LeapMotion only allows a single active device at a time,
